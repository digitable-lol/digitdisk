...
var keys = []string{
	...
	"  --no-fold         analyze: судить о каждом файле внутри node_modules и",
	"                    подобных каталогов; по умолчанию такой каталог",
	"                    считается целиком, а приговор выносится один — о нём",
