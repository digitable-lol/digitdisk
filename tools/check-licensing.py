...
лицензия и выбрана: «No GPL in the tree» из digitwm/tools/check-licensing.py и
запрет копилефта в платном архиве из
    ...
    for marker in COPYLEFT_MARKERS:
        if marker in text:
            copyleft_hits.append(
                ...
                f"(digitwm/tools/check-licensing.py, workbench/license-gate.mjs). "
